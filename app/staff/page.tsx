        ...
        <div className="min-h-screen bg-[#FFF5F8] flex items-center justify-center p-6 bg-[radial-gradient(circle_at_20%_20%,#FFD1DC_0%,transparent_25%),radial-gradient(circle_at_80%_80%,#FFB7C5_0%,transparent_25%)]">
            <div className="bg-white/80 backdrop-blur-2xl w-full max-w-sm p-10 rounded-[3rem] shadow-[0_32px_64px_-16px_rgba(255,182,197,0.3)] border border-pink-100/50 text-center relative overflow-hidden">
                ...
                <div className="relative mb-10">
                    ...
                    <p className="text-[10px] text-[#FF85A1] font-black uppercase tracking-[0.2em] mt-2 leading-relaxed">
                        Staff Login Portal
                    </p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-4 relative">
                    <div className="group">
                        <input
                            ...
                            className={`w-full bg-white p-5 rounded-[1.8rem] font-bold outline-none border-2 transition-all shadow-sm text-[#411E24] ${error ? 'border-red-400 bg-red-50 text-red-500' : 'border-pink-50 focus:border-[#FFB7B2] group-hover:border-pink-100'}`}
                            value={email}
                    ...
                    <div className="group relative">
                        <input
                            ...
                            className={`w-full bg-white p-5 rounded-[1.8rem] font-bold outline-none border-2 transition-all shadow-sm pr-14 text-[#411E24] ${error ? 'border-red-400 bg-red-50 text-red-500' : 'border-pink-50 focus:border-[#FFB7B2] group-hover:border-pink-100'}`}
                            value={password}
                ...
                <p className="text-[9px] text-[#FF85A1] mt-10 font-bold uppercase tracking-widest">© 2026 Management Portal v1.0</p>
            </div>
        </div>
    );
}
